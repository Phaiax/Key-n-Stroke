...
namespace PxKeystrokesWPF.Updater
{
    class Utils
    {
        #region Exceptions
        ...
        {
            Stream pubKeyStream = Application.GetResourceStream(new Uri("pack://application:,,,/PxKeystrokesWPF;component/Resources/updateKey.pub.xml")).Stream;
            RSA pub = RSA.Create();
